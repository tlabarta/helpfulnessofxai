...
#Source: https://shap-lrjball.readthedocs.io/en/latest/example_notebooks/gradient_explainer/Explain%20an%20Intermediate%20Layer%20of%20VGG16%20on%20ImageNet.html
...
def explain(model, img, org_img, labels):
    ...
    shap.image_plot(shap_values=shap_values, pixel_values=org_img.reshape(1, 224, 224, 3) / 255, cmap=bwr,
