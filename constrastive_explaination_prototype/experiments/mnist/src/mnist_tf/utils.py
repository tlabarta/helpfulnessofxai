...
from mnist_tf.setup_mnist import MNIST, MNISTModel


def load_AE(
    path="constrastive-explaination-prototype/experiments/mnist/models/AE_codec",
    codec_prefix="/mnist_AE_1",
    print_summary=False,
):

    saveFilePrefix = path + codec_prefix + "_"
...
def setup_mnist(model_path: str, ae_path: str) -> Tuple[MNIST, MNISTModel, tf.keras.Model]:
    data, model, AE = (
        MNIST(),
        MNISTModel(
            model_path,
